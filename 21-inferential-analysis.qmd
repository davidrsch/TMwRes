...
::: rmdnote
Entre [`r pkg(broom)`](https://broom.tidymodels.org/) y [`r pkg(broom.mixed)`](https://CRAN.R-project.org/package= broom.mixed), existen métodos `tidy()` para más de 150 modelos.
:::
