...
## Using Recipes {#sec-using-recipes}
...
#| echo: FALSE
#| results: 'asis'
#| tbl-cap: "Illustration of binary encodings (i.e., dummy variables) for a qualitative predictor."
...
### Spline functions {#sec-spline-functions}
...
The `ns()` function in the `r pkg(splines)` package generates feature columns using functions called *natural splines*.
